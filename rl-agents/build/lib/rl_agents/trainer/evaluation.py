...
class Evaluation(object):
    ...
    def test(self):
        ...
        try:
            ...
            pass
        state, action, img = self.run_episodes()
        #self.run_episodes()
        self.close()
    ...
    def run_episodes(self):
        for self.episode in range(self.num_episodes):
            ...
            while not terminal:
                ...
                reward, terminal, previous_observation, action, img = self.step()
            ...
            if (self.training == False):
              return state_log, action_log, img_log
    ...
    def step(self):
        ...
        return reward, terminal, previous_observation, action, img
